...
#include "src/TimeStretch2.cpp"
#if (FAUST_INPUTS - FAUST_OUTPUTS) > 0
#error Number of inputs and outputs in faust code must match!
#endif
namespace project {
struct TimeStretch2MetaData {
		SN_NODE_ID("TimeStretch2");
};
template <int NV, class ModParameterClass=scriptnode::parameter::empty_list>
using TimeStretch2 = scriptnode::faust::faust_static_wrapper<NV, ModParameterClass, _TimeStretch2, TimeStretch2MetaData, FAUST_OUTPUTS>;
} // namespace project
 // undef dummy macros
