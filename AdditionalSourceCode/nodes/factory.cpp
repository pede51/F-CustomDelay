...
struct Factory: public scriptnode::dll::StaticLibraryHostFactory
{
	Factory()
	{
		...
		registerPolyNode<project::TimeStretch2<1>, project::TimeStretch2<NUM_POLYPHONIC_VOICES>>();
		registerPolyNode<project::script_fx1<1>, project::script_fx1<NUM_POLYPHONIC_VOICES>>();
